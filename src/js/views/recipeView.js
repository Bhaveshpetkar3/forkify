import icons from 'url:../../img/icons.svg'; //importing the icons bcz the icon name changes.
import View from './view.js';
import fracty from 'fracty';
//console.log(fracty(3.5));
...
export default new RecipeView(); //Default exports are useful to export only a single object, function, variable. During the import, we can use any name to import
